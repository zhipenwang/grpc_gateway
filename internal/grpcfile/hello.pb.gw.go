...
/*
Package rpc_proto is a reverse proxy.
...
var (
	pattern_Hello_SayHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"http", "hello"}, "", runtime.AssumeColonVerbOpt(true)))
)
